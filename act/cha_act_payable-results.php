...
<?php 
    ...
    if (isset($_POST['sname']) && isset($_POST['amount']) && isset($_POST['date'])) {
  include 'cha_act_payable-data.php';
      ...
      echo "<p><strong>Supplier Name:</strong> " . $sname . "</p>";
...
<script>
  ...
  function updateCountdown() {
    ...
    if (countdownTime < 0) {
        window.location.href = "cha_act_payable-view.php";
    } else {
