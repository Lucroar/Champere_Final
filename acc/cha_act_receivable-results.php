...
<?php 
    ...
    if (isset($_POST['clname']) && isset($_POST['amntrcv']) && isset($_POST['date'])) {
  include 'cha_act_receivable-data.php';
      ...
      echo "<p><strong>Client Name:</strong> " . $clname . "</p>";
      echo "<p><strong>Amount Receive:</strong> " . $amntrcv . "</p>";
...
<script>
  ...
  function updateCountdown() {
    ...
    if (countdownTime < 0) {
        window.location.href = "cha_act_receivable-view.php";
    } else {
